...
class informations_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nSdomiciliar.text = arrayBoletim.sDomiciliar.toString()
        nShospitalar.text = arrayBoletim.sHospitalar.toString()
        nChospitalar.text = arrayBoletim.Chospitalar.toString()
        data.text = arrayBoletim.data
        hora.text = arrayBoletim.hora
